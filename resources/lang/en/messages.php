...
return [
	...
	'home' => [
		//'title' => 'Get there',
		'title' => '',
		'desc' => ' Alesha Ride Truly Reliable',
		'siginup' => 'Sign Up',
		'or' => 'Or',
		...
		'siginup_company' => 'Sign up to Partner',
		'company' => 'Partner',
		'company_history' => 'Find everything you need to track your success on the Partner.',
		'company_signin' => 'Partner SIGN IN',
		'company_signup' => 'Partner SIGN UP',
		'become_company' => 'BECOME A Partner',
		...
		'anywhere_content' => 'Daily travel to and from work. Run across town. Early morning flight. Moving around late night. Wherever you’re headed, count on for a ride, no reservations required.',
		'lowcost' => 'Low-cost to luxury',
		'lowcost_content' => 'Economy cars at everyday prices are always available. For special occasions, no occasion at all, or when you just a need a bit more room, call for our premium services.',
	...
	'profile' => [
		...
		'nid_passport' => 'Number',
		'nid_passport_number'=> 'NID/ Passport',
		
	],

	'drive' => [
		// 		'start_drive_with' => 'Start driving with',
		'start_drive_with' => 'Start with',
		...
		'all_round_initiatives_for_your_Trip_Safety' => 'All-round initiatives for your Trip Safety',
		'protection_against_covid_19' => 'Protection against COVID-19',
		'a_great_Prices_without_Shock!' => 'A great Prices without Shock!',
		'driver_Screening' => 'Driver Screening',
		'sos_Button' => 'SOS Button',
		'immediate_pickups' => 'Immediate pickups',
		'high_quality_standards' => 'High quality standards',
		'with_you_on_the_road' => 'With you on the road',

		'all_round_initiatives_for_your_Trip_Safety2' => 'To the office, to the home, to the hospital, to the airport. For you, for your mother or for your daughter. Whatever your trip, we want you to feel calm.  We commit to improve our service and safety standards to ensure an enjoyable rideshare experience for both riders and drivers. Each journey that you make with us is tracked in real time and you can share this information, as well as the vehicle type, driver details and registration plate, with your friends and family. We use modern vehicles and our drivers have each been through a careful selection process and training program and hold all the necessary licenses and insurance.',
		'protection_against_covid_192' => 'Vehicles disinfected periodically, screens, and masks for drivers. We emphasize our hygiene measures to travel with greater safety.',
		'a_great_Prices_without_Shock!2' => 'You will always know the price of the trip before ordering it, without scares, without surprises. And yes with affordable and transparent prices.',
		'driver_Screening2' => 'To ensure all Alesha driver-partners are of the highest quality, they’re required to pass a series of safety verifications and background checks prior to driving.',
		'sos_Button2' => 'With the tap of a button, you can contact law enforcement and emergency services. Your location details will also be shown in-app for easy reference.',
		'immediate_pickups2' => 'Our Innovative technology is designed to ensure immediate pickups.',
		'high_quality_standards2' => 'Our drivers are not only friendly people, they are also excellent professionals behind the wheel of cars that exceed our quality standards to give you the best service.',
		'with_you_on_the_road2' => 'We have security functions integrated into our app and a team ready 24 hours a day so that, in the event of an emergency, you are in good hands.',
		...
		'min_requirments' => 'Please have the following documents ready-',
		...
		'updated_driving_license' => 'Updated Driving License',
		'nid_passport' => 'NID/Passport',
		'enlistment_certificate' => 'Ride share enlistment certificate',
		'vehicle_insurance' => 'Vehicle Insurance',
		'tax_token' => 'Tax Token',
		'updated_fitness_paper' => 'Updated Fitness Paper',
		'vehicle_registration_paper' => 'Vehicle Registration Paper ',

		'fill_up_the_signup_form' => 'Fill up the signup form',
		'upload_the_scan_copy_of_required_documents' => 'Upload the scan copy of required documents',
		'wait_for_the_confirmation' => 'Wait for the confirmation',
		'start_earning' => 'Start Earning',

		'our_commitment' => 'Start Earning',
		...
		'follow_the_registration_steps' => 'Follow the registration steps-',
	...
	'driver_dashboard' => [
		...
		'no' => 'No',
		'available' => 'Available',
		'is_our_employee' => 'is our employee',
	],
	'errors' => [
	...
	'ride' => [
		...
		'ride_with_gofer' => 'Start with :site_name',
		...
		'pool_content' => 'matches you with riders headed in the same direction. It’s always the cheapest way to',
		...
		'follow_trip' => 'Follow your trip in real-time so you always know where you are if you use',
		'follow_trip_content' => '',
	...
	'user' => [
		...
		'ride_with'                     => 'Ride With',
		'update'                        => 'Update',
		'email_address'                 => 'Mobile number',
		'mobile_no'                     => 'The Mobile Number should be minimum 11 characters',
		'disabled_account'              => 'The user has been disabled',
		'disabled_company_account'      => 'The company has been Blocked By admin',
		'no_recognize'                  => 'This mobile number can\'t be recognized by ',
		'no_recognize_email'            => 'This email can\'t be recognized by ',
		...
		'pending_message'               => 'Your paper should be approved by Alesha Ride',
		'profile_picture_message'       => 'Please upload your profile picture',
		...
		'invalid_info'                  => 'Provided information is not valid.',
	],
	...
	'remarks' => [
		...
		'status' => 'Status',
		'view_permission' => 'You are not permitted to view conversation details',
	],
	...
	'wallet_amount' => 'Balance amount',
	'wallet_amount_show_for_driver' => 'Rider Balance amount',
	'driver_payout' => 'Driver payout',
	'driver_or_company_commission' => 'Driver or Company Commission',
	'applied_owe_amount' => 'Applied owe amount',
	'owe_amount' => 'Payable to Alesha Ride', //'Owe amount',
	'payout_amount' => 'Alesha Ride will pay you', //'payout_amount',
	'cash_collected' => 'Collectable Cash',
	'distance_fare' => 'Distance Fare',
	'schedule_fare' => 'Schedule Fare',
	'promo_amount' => 'Promo', //'Promo Amount',
	...
	'rider_access_fee' => 'Rider Access fee',
	'distance' => 'Distance',
	'time' => 'Time',
	'km' => 'km',
	'min' => 'min',
	'total_trip_fare' => 'Total trip fare',
	'payable_amount'   => 'Net Fare',	//'Payable Amount',
	...
	'referrals' => [
		...
		'referral_credited_desc'		=> 'Referral Amount Credited to Your Balance',
		...
		'Expired'						=> 'Expired',
		'Completed'						=> 'Completed',
		'input_nid_passport'			=> 'NID / Passport',
	],
	...
	'api' => [
		'driver_user_type_error'            => 'User Must Be Driver',
		...
		'total_fare'                        => 'Total Fare',
		'total_fare_tooltip'                => 'Fare includes time,distance and others fares.',
		'admin_remaining_amount'            => 'Payout Amount',
		...
		'payout'                            => 'Payout',
		'paid_to_alesha'                    => 'Paid to Alesha',
		'received_from_alesha'              => 'Received from Alesha',
		'nid_digit'                         => 'NID Number must be 10, 13 or 17 digits.',
		'nid_unauthorized'                  => 'Due to technical problem, we can\'t verify you.',
		'db_not_save'                       => 'Due to technical problem, we can\'t verify you.',
		'nid_no_exists'                     => 'NID number already exists',
		'driver_used_nid'                   => 'Another Driver already used this NID.',
		'you_used_nid'                      => 'this user already used this NID.',
		'nid_invalid'                       => 'NID number is not valid',
		'nid_required'                      => 'NID number is required.',
		'verification_email_send_success'   => 'Verification email send successfully to ',
		'verification_email_send_unsuccess' => 'Unable to send verification email',
		'not_save'                          => 'Your information did not save. Please try later.',
		'invalid_info'						=> 'Your Provided Information is not valid.',
		'save_success'						=> 'Your Provided Information is saved successfully.',
