...
return [
	...
	'dashboard' => [
		...
		'access_fee' => 'সার্ভিস ফি',
		'wallet_amt' => 'মোট পরিমান',
		'promo_amt' => 'প্রমো টাকার পরিমান',
	...
	'user' => [
		...
		'profile_update_success' => 'প্রোফাইল সফলভাবে আপডেট হয়েছে',
		...
		'active_message' => 'আপনার প্রোফাইল সক্রিয় করা হয়েছে',
		// 'pending_message' => 'Please wait until get approval from admin for car or document details',
		'pending_message' => 'খুব শিগ্রই আপনার ডকুমেন্ট আলেশা রাইড দ্বারা অনুমোদিত হবে দয়াকরে অপেক্ষা করেন ',
		'profile_picture_message' => 'দয়াকরে প্রোফাইলের ছবি সংযুক্ত করেন',
		'car_details_message1' => 'আপনার গাড়ির বিবরণ আপলোড করুন ',
		'car_details_message2' => 'আপনার গাড়ির নথি বিবরণ আপলোড করুন',
		'document_details_message' => 'আপনার ড্রাইভার নথির বিশদ আপলোড করুন',
		'inactive_message' => 'আপনার প্রোফাইল নিষ্ক্রিয় করা হয়েছে',
	...
	//Web Service
	'credentials' => 'আপনার লগইন এর তথ্য সঠিক নয় আবার চেষ্ট্রা করেন',
	'login_success' => 'Login Success',
	'password_reset_success' => 'Password Changed Successfully',
	'inactive_admin' => 'আপনার একাউন্ট ডিঅ্যাক্টিভেটেড..প্লিজ অ্যাডমিনের সাথে যোগাযোগ করুন',
	...
	'already_have_account' => 'ইতিমধ্যে আপনার একটি অ্যাকাউন্ট আছে, দয়া করে লগইন করুন',
	...
	'wallet_amount' => 'রাইডারের ব্যালান্স এর টাকা',
	'wallet_amount_show_for_driver' => 'রাইডারের ব্যালান্স এর টাকা',
	'driver_payout' => 'Driver payout',
	'driver_or_company_commission' => 'Driver or Company Commission',
	'applied_owe_amount' => 'Applied owe amount',
	'owe_amount' => 'আলেশার প্রাপ্য',
	'payout_amount' => 'আলেশা থেকে আপনি পাবেন', //'payout_amount',
	'cash_collected' => 'সংগ্রহযোগ্য টাকা',
	'distance_fare' => 'দূরত্বের ভাড়া',
	'schedule_fare' => 'সিডিউলের ভাড়া',
	'promo_amount' => 'প্রমো টাকার পরিমান',
	'total_km_fare' => 'মোট কিলোমিটারের ভাড়া',
	'time_fare' => 'সময় ভাড়া',
	'total_trip_fare' => 'মোট ভ্রমণের ভাড়া',
	'collectable_amount' => 'সংগ্রহযোগ্য টাকা',
	'payable_amount'   => 'প্রদানযোগ্য টাকা',
	'net_income' => 'মোট আয় ',
	'net_fare' => 'নিট ভাড়া',
	'peak_fare' => 'পিক ভাড়া',
	'number_does_not_exists' => 'সংখ্যা বিদ্যমান নেই',
	'peak_time_fare' => 'পিক সময়ের ভাড়া',
	'normal_fare' => 'সাধারণ ভাড়া',
	'rider_access_fee' => 'রাইডারের সার্ভিস ফি',
	'distance' => 'দূরত্ব',
	'time' => 'সময়',
	'km' => 'কি. মি.',
	'min' => 'মিনিট',
	'tips' => 'বকশিস',
	'toll_fee' => 'টোল ফি',
	'subtotal_fare' => 'সাব টোটাল',
	'trip_min_fare' => 'মোট ভাড়া',
	'discount' => 'ডিসকাউন্ট',
	'driver_fee' => 'ড্রাইভার ফি',
	'rider_fee' => 'রাইডার ফি',
	...
	'api' => [
		...
		'rating_successfully' => 'রেটিং সফল হয়েছে',
		...
		'driver_earnings'		=> 'ড্রাইভার এর আয়',
		'trip_earning'			=> 'আয়',
		'total_fare'			=> 'মোট ভাড়া',
		'total_fare_tooltip'	=> 'Fare includes time,distance and others fares.',
		'admin_remaining_amount' => 'পে-আউট টাকার পরিমান',
		...
		'balance_withdraw'		=> 'ব্যালেন্স উত্তোলন',
		'payout'				=> 'পরিশোধ',
		'paid_to_alesha'		=> 'আলেশাকে দেওয়া',
		'received_from_alesha'	=> 'আলেশা থেকে প্রাপ্ত',

		'nid_digit'				=> 'জাতীয় পরিচয়পত্র নম্বর ১০, ১৩ বা ১৭ ডিজিটের হতে হবে।',
		'nid_unauthorized'		=> 'প্রযুক্তিগত সমস্যার কারণে, আমরা আপনাকে যাচাই করতে পারছি না।',		
		'db_not_save'			=> 'প্রযুক্তিগত সমস্যার কারণে, আমরা আপনাকে যাচাই করতে পারছি না।',
		'nid_no_exists' 		=> 'জাতীয় পরিচয়পত্র নম্বর ইতিমধ্যেই বিদ্যমান।',
		'nid_invalid' 			=> 'জাতীয় পরিচয়পত্র নম্বর বৈধ নয়',
