...
<header class="main-header hide">
    <!-- Logo -->
    <a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}" style="background-color: #26BBB9" class="logo">
    ...
    <nav class="navbar navbar-static-top" style="background-color: #26BBB9"  role="navigation">
