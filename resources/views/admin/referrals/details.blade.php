...
<div class="content-wrapper">
	<section class="content-header">
		<h1> Referrals <small>{{ucwords($user_type)}} Details </small></h1>
		<ol class="breadcrumb">
			<li>
			...
			<li>
				<a href="{{ url(LOGIN_USER_TYPE.'/referrals/'.$user_type) }}"> {{ucwords($user_type)}} </a>
			</li>
			<li>
				<a href="{{ url(LOGIN_USER_TYPE.'/referrals/'.@$id) }}"> Details </a>				
			</li>
		</ol>
	</section>
