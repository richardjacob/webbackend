...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>Manage Driver <small>Drivers Documents</small></h1>
      <ol class="breadcrumb">
        <li>
         ...
         <div class="col-xs-12">
            <div class="box">
              <div class="text-right">
                <a href="{{url(LOGIN_USER_TYPE.'/drivers_documents/only_checked_documents')}}" class="text-primary">Only checked Documents</a> &nbsp;
              </div>
               <div class="box-header">
                  {!! Form::open(['url' => LOGIN_USER_TYPE.'/drivers_documents', 'class' => 'form-horizontal', 'method' => 'GET', 'id' => 'frm']) !!}
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="col-sm-2">
                      <select name="given" class="form-control">
                        <option value="">Select</option>
                        @foreach(array('Given','Not Given') as $p)
                          <option value="{{$p}}" 
                          @if($p == @$given AND $req !='') selected @endif
