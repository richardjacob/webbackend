			...
			<div class="col-md-12 col-sm-offset-0">
				<div class="box box-info">
					...
					*/ ?>
					<?php /*
					<!-- Nagad Section Start -->
					<div class="box-body" ng-init="nagad_enabled={{ old('nagad_enabled',payment_gateway('is_enabled','Nagad')) }}">
						<div class="form-group">
								<label for="input_nagad_enabled" class="col-sm-3 control-label">Is Nagad Enabled <em class="text-danger">*</em> </label>
								<div class="col-sm-6">
									{!! Form::select('nagad_enabled', array('0' => 'No', '1' => 'Yes'), old('nagad_enabled',payment_gateway('is_enabled','Nagad')), ['class' => 'form-control', 'id' => 'input_nagad_enabled','ng-model' => 'nagad_enabled']) !!}
									<span class="text-danger">{{ $errors->first('nagad_enabled') }}</span>
								</div>
							</div>
						<div class="form-group">
							<label for="input_mode" class="col-sm-3 control-label"> Payment Mode <em ng-show="nagad_enabled == '1'" class="text-danger">*</em> </label>
							<div class="col-sm-6">
								{!! Form::select('nagad_mode', array('sandbox' => 'Sandbox', 'live' => 'Live'), old('nagad_mode'
								,payment_gateway('mode','Nagad')), ['class' => 'form-control', 'id' => 'input_mode']) !!}
								<span class="text-danger">{{ $errors->first('mode') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_merchant_id" class="col-sm-3 control-label"> Nagad Merchant ID <em ng-show="nagad_enabled == '1'" class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::text('nagad_merchant_id', old('nagad_merchant_id',payment_gateway('merchant_id','Nagad')), ['class' => 'form-control', 'id' => 'input_merchant_id', 'placeholder' => 'Merchant ID']) !!}
								<span class="text-danger">{{ $errors->first('nagad_merchant_id') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_nagad_account_number" class="col-sm-3 control-label"> Nagad Account Number <em ng-show="nagad_enabled == '1'" class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::text('nagad_account_number', old('nagad_account_number',payment_gateway('account_number','Nagad')), ['class' => 'form-control', 'id' => 'input_nagad_account_number', 'placeholder' => 'Nagad Number']) !!}
								<span class="text-danger">{{ $errors->first('nagad_account_number') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_nagad_public" class="col-sm-3 control-label"> Nagad Public Key <em ng-show="nagad_enabled == '1'" class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::text('nagad_public_key', old('nagad_public_key',payment_gateway('public_key','Nagad')), ['class' => 'form-control', 'id' => 'input_nagad_public', 'placeholder' => 'Public Key']) !!}
								<span class="text-danger">{{ $errors->first('nagad_public_key') }}</span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_nagad_private_key" class="col-sm-3 control-label"> Nagad Private Key <em ng-show="nagad_enabled == '1'" class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::text('nagad_private_key', old('nagad_private_key',payment_gateway('private_key','Nagad')), ['class' => 'form-control', 'id' => 'input_nagad_private_key', 'placeholder' => 'Private Key']) !!}
								<span class="text-danger">{{ $errors->first('nagad_private_key') }}</span>
							</div>
						</div>
					</div>
					<!-- Nagad Section End -->
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<div ng-init="payout_method_{{ $payout_method['key'] }}={{ isPayoutEnabled($payout_method['key']) }}" style="height:50px;">
										<input type="checkbox" name="payout_methods[]" id="payout_method-{{ $payout_method['key'] }}" value="{{ $payout_method['key'] }}" ng-checked="{{ isPayoutEnabled($payout_method['key']) }}"> <label for="payout_method-{{ $payout_method['key'] }}" ng-model="payout_method_{{ $payout_method['key'] }}" style="margin-top:-20px;"> {{ $payout_method["value"] }} 
											<img src="{{asset('images/icon/'.$payout_method['key'].'.png')}}" style="height:30px;margin-left:20px;">
										</label>
									</div>										
									@endforeach
								</div>
