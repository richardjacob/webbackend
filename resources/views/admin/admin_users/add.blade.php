      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-offset-0">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => 'admin/add_admin_user', 'class' => 'form-horizontal', 'onSubmit' => '' ]) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::tel('mobile_number', old('mobile_number'), ['class' => 'form-control', 'id' => 'input_mobile', 'placeholder' => 'Mobile', 'pattern' => '[1]{1}[0-9]{9}' ]) !!}
