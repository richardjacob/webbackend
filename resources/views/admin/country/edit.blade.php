...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Country <small>Edit Country</small></h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/country') }}">Manage Country</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/edit_country/'.@$result->id) }}">Edit</a></li>
      </ol>
    </section>
