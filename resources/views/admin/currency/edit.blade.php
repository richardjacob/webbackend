...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Currency <small>Edit Currency</small></h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/currency') }}">Manage Currency</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/edit_currency/'.@$result->id) }}">Edit</a></li>
      </ol>
    </section>
