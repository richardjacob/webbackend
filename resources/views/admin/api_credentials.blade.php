...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="{{ url(LOGIN_USER_TYPE.'/api_credentials') }}">Api Credentials</a></li>	
		</ol>
	</section>
		...
		<div class="row">
			<div class="col-md-12 col-sm-offset-0">
				<div class="box box-info">
					...
					<div class="box-body">
						<div class="form-group">
							<label for="input_onnorokom_token" class="col-sm-3 control-label">Onnorokom SMS Key <em class="text-danger">*</em></label>
							<div class="col-sm-6">
								{!! Form::text('onnorokom_token', api_credentials('token','Onnorokom'), ['class' => 'form-control', 'id' => 'input_onnorokom_token', 'placeholder' => 'Onnorokom Token']) !!}
								<span class="text-danger">{{ $errors->first('onnorokom_token') }}</span>
							</div>
						</div>
					</div>
