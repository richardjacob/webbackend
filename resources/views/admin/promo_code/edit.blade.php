...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <h1>Manage Balance & Promo <small>Edit Promo Code</small> </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Balance & Promo</li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/promo_code') }}">Manage Promo Code</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/edit_promo_code/'.@$result->id) }}">Edit</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12 col-sm-offset-0">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Promo Code Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
               <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('code',$result->code, ['class' => 'form-control', 'id' => 'input_promo_code', 'placeholder' => 'Promo Code']) !!}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('expire_date',$result->expire_date_mdy, ['class' => 'form-control', 'id' => 'input_expired_at', 'placeholder' => 'Expire Date', 'autocomplete' => 'off']) !!}
