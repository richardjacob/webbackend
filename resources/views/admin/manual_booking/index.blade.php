...
<div class="manual-booking content-wrapper" ng-controller='manual_booking' ng-init="vehicle_types = {{$vehicle_types}}">
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2 cls_manualbook" ng-init="country_code = {{ @$schedule_ride->users->country_code==null ? $country_code_option[0]->phone_code:@$schedule_ride->users->country_code }}">
