  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a href="{{ url(LOGIN_USER_TYPE.'/company/transaction_history/paid_to_alesha/'.$company_id) }}"> Paid to Alesha</a>
        </li>
        @else
        <li class="active">
        ...
        <li>
          <a href="{{ url(LOGIN_USER_TYPE.'/transaction_history/paid_to_alesha') }}"> Paid to Alesha</a>
        </li>
        @endif
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
                ...
                @if(LOGIN_USER_TYPE == 'admin')
                  @if($url = LOGIN_USER_TYPE.'/company/transaction_history/paid_to_alesha/'.$company_id) @endif
                @elseif(LOGIN_USER_TYPE == 'company')
                  @if($url = LOGIN_USER_TYPE.'/transaction_history/paid_to_alesha') @endif
                @endif
