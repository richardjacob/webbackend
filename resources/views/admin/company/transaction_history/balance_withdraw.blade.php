  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a href="{{ url(LOGIN_USER_TYPE.'/company/transaction_history/balance_withdraw/'.$company_id) }}"> Balance Withdraw</a>
        </li>
        @else
        <li class="active">
        ...
        <li>
          <a href="{{ url(LOGIN_USER_TYPE.'/transaction_history/balance_withdraw') }}"> Balance Withdraw</a>
        </li>
        @endif
      </ol>
    </section>    
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
                ...
                @if(LOGIN_USER_TYPE == 'admin')
                  @if($url = LOGIN_USER_TYPE.'/company/transaction_history/balance_withdraw/'.$company_id) @endif
                @elseif(LOGIN_USER_TYPE == 'company')
                  @if($url = LOGIN_USER_TYPE.'/transaction_history/balance_withdraw') @endif
                @endif
