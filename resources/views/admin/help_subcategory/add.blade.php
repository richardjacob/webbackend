...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Help <small>Sub Category</small></h1>
      <ol class="breadcrumb">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>        
        <li class="active">Manage Help</li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/help_subcategory') }}">Sub Category</a></li> 
        <li><a href="{{ url(LOGIN_USER_TYPE.'/add_help_subcategory') }}">Add</li>
      </ol>
    </section>
