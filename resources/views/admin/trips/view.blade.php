...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Manage Trips <small>Trips Details</small></h1>
		<ol class="breadcrumb">
			<li>
            ...
            <li><a href="{{ url(LOGIN_USER_TYPE.'/trips/'.@$result->id) }}"> Trips Details</a></li>
		</ol>
	</section>
			...
			<div class="col-md-12 col-sm-offset-0">
				<div class="box box-info" id="printableArea">
					...
					<div class="box-footer text-center">
						...
						<a href="{{url(LOGIN_USER_TYPE.'/print_trips/'.$result->id)}}" class="btn btn-primary"><i class="fa fa-print"> Print</i>
						</a>
					</div>
