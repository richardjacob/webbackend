 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    <section class="content-header">
        <h1>Manage Trips <small>Manage Ride Requests</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Manage Trips</li>
            <li><a href="{{ url(LOGIN_USER_TYPE.'/request') }}"> Manage Ride Requests</a></li>
            <li><a href="{{ url(LOGIN_USER_TYPE.'/detail_request/'.$request_details->id) }}"> Details</a></li>
        </ol>
    </section>
            ...
            <div class="box-body">            
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    @if(isset($is_tripped))
                        <img src="{{ str_replace(env('ADMIN_PANEL_SUB_DOMAIN').'.', '', $trip_data->map_image)}}" data-original_src="{{ $trip_data->getOriginal('map_image') }}" class="img trip_image" id="trip_image">
                    @endif
                </div>
            </div>
          </div>
