  ...
  <div class="content-wrapper ng-cloak" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url(LOGIN_USER_TYPE.'/send_message') }}">Send Message</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              {!! Form::open(['url' => LOGIN_USER_TYPE.'/send-bulk-sms', 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                <div class="form-group">
                  <label class="col-sm-3 control-label radio_label">Message Priority<em class="text-danger">*</em></label>
                  <div class="col-sm-2">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="txtEditor" ng-model="inputMessage" maxlength="160" name="txtEditor" required></textarea>
...
$(".message_type").change(function() {
  if($(".message_type:checked").val() == 'push') {
    ...
    $("#user_label_type").parent().addClass('col-sm-2');
    $("#user_label_type").parent().removeClass('col-sm-3');
    ...
    $("#user_label_type").parent().removeClass('col-sm-2');
    $("#user_label_type").parent().addClass('col-sm-3');
