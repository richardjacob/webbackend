...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Manage Language<small> Edit Language</small></h1>
    <ol class="breadcrumb">
      <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="{{ url(LOGIN_USER_TYPE.'/language') }}">Manage Language</a></li>
      <li><a href="{{ url(LOGIN_USER_TYPE.'/edit_language/'.@$result->id) }}">Edit</a></li>
    </ol>
  </section>
  <!-- Main content -->
