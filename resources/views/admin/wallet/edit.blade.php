...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Balance & Promo <small>Edit Balance - {{ $user_type }}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/wallet/'.$user_type) }}">Manage Balance & Promo</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/wallet/edit/'.$user_type.'/'.@$result->user_id) }}">Edit</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12 col-sm-offset-0">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Balance Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
