...
<div class="content-wrapper" ng-controller="hub_employee">
  ...
  <section class="content-header">
    <h1>Manage Driver <small>Add Monitor & Camera</small></h1>
    <ol class="breadcrumb">
      ...
      <li class="active">
            <a href="{{url(LOGIN_USER_TYPE.'/add_monitor_camera')}}">Add</a>
      </li>
    </ol>
  </section>
<style> 
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => 'admin/add_monitor_camera', 'class' => 'form-horizontal']) !!}
          <div class="box-body">
            ...
            <div class="form-group" id="email_textbox">
              ...
              <div class="col-sm-6">
                ...
                {!! Form::text('driver_name', '', ['class' => 'form-control search-box', 'id' => 'input_email', 'data-id' => 'search-box', 'placeholder' => 'Enter Name or Number', 'autocomplete' => 'off','ng-change' => 'change_driver(driver_id)', 'ng-model' => 'driver_id']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('monitor_sim', '', ['class' => 'form-control', 'id' => 'monitor_sim', 'placeholder' => 'Monitor Sim Number']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('monitor_imei', '', ['class' => 'form-control', 'id' => 'monitor_imei', 'placeholder' => 'Monitor IMEI']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('monitor_ip', '', ['class' => 'form-control', 'id' => 'monitor_ip', 'placeholder' => 'Monitor IP']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::select('monitor_status', array('Active' => 'Active', 'Inactive' => 'Inactive', 'Problem' => 'Problem', 'Not Connected' => 'Not Connected'), '', ['class' => 'form-control', 'id' => 'monitor_status', 'placeholder' => 'Monitor Status']) !!}
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('camera_sim', '', ['class' => 'form-control', 'id' => 'camera_sim', 'placeholder' => 'Camera Sim Number']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('camera_imei', '', ['class' => 'form-control', 'id' => 'camera_imei', 'placeholder' => 'Camera IMEI']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::text('camera_ip', '', ['class' => 'form-control', 'id' => 'camera_ip', 'placeholder' => 'Camera IP']) !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                {!! Form::select('camera_status', array('Active' => 'Active', 'Inactive' => 'Inactive', 'Problem' => 'Problem', 'Not Connected' => 'Not Connected'), '', ['class' => 'form-control', 'id' => 'camera_status', 'placeholder' => 'Camera Status']) !!}
