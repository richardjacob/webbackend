      ...
      <div class="row">
        ...
        <div class="col-md-12 col-md-offset-0">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/add_complain_sub_category', 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('complain_cat_id', $cat_list, '', ['class' => 'form-control', 'id' => 'input_complain_cat_id', 'placeholder' => 'Select']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('sub_category', '', ['class' => 'form-control', 'id' => 'input_sub_category', 'placeholder' => 'Sub Category Name in English']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('sub_category_bn', '', ['class' => 'form-control', 'id' => 'input_sub_category_bn', 'placeholder' => 'Sub Category Name in Bangla']) !!}
