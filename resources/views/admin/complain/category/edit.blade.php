...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Complain <small>Edit Category</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Complain</li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/complain_category') }}">Category</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/edit_complain_category/'.@$result->id) }}">Edit</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-md-offset-0">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/edit_complain_category/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('category', $result->category, ['class' => 'form-control', 'id' => 'input_category', 'placeholder' => 'Category Name in English']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('category_bn', $result->category_bn, ['class' => 'form-control', 'id' => 'input_category_bn', 'placeholder' => 'Category Name in Bangla']) !!}
