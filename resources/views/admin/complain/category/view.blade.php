        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              @if(Auth::guard('admin')->user()->can('add_complain_category'))
                <div style="float:right;"><a class="btn btn-success" href="{{ url('admin/add_complain_category') }}">Add Category</a></div>
              @endif
            </div>
            <!-- /.box-header -->
