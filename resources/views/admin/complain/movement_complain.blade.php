...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Complain <small>Add Movement</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url(LOGIN_USER_TYPE.'/dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Complain</li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/complain_list') }}">Complain List</a></li>
        <li><a href="{{ url(LOGIN_USER_TYPE.'/movement_complain/'.$result->id) }}">Add Movement</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/movement_complain/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-success">
              <div class="box-header with-border">
                  ...
                  <div class="col-sm-1 text-right">   
                    @if(auth('admin')->user()->can('tracking_movement_complain'))             
                    <a href="{{ url('admin/tracking_movement_complain'.$result->id)}}" class="btn btn-xs btn-success" title="Tracking">
            ...
            @if(is_object($last_record))
                {!! Form::open(['url' => 'admin/edit_movement_complain', 'class' => 'form-horizontal']) !!}
                <div class="box-body">
                <span class="text-danger">(*)Fields are Mandatory</span>
                <input type="hidden" name="complain_movement_id" value="{{ $last_record->id }}">
