...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-9" style="padding:6px 0px;">
      <input class="_style_3vhmZK" id="mobile" name="mobile_number" disabled="true" style="background-color:#ddd!important" value="{{ @$result->mobile_number}}" placeholder="{{trans('messages.profile.mobile')}}" readonly="">
      <span class="text-danger">{{ $errors->first('mobile_number') }}</span>
    </div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="margin-left: 5px;padding:6px 0px;">
      <?php /*<input type="button" class="_style_3vhmZK" name="change_number" value="{{ trans('messages.profile.change') }}" id="submit-btn" ng-click="changeNumberPopup('show_popup')">
      */ ?>
    </div>
  </div>
</div>
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-9" style="padding:6px 0px;">
      {!! Form::text('gender', $result->gender_text, ['class'=>'_style_3vhmZK phone-no', 'disabled'=>'true','style'=>'background-color:#ddd!important']) !!}
    </div>
  </div>
</div>
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:6px 0px;">{{trans('messages.profile.nid_number')}}</label>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-9" style="padding:6px 0px;">
      {!! Form::text('nid_number', $result->nid_number, ['class'=>'_style_3vhmZK nid_number', 'disabled'=>'true','style'=>'background-color:#ddd!important']) !!}
    </div>
  </div>
</div>
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding:6px 0px;">{{trans('messages.profile.passport_number')}}</label>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-9" style="padding:6px 0px;">
      {!! Form::text('passport_number', $result->passport_number, ['class'=>'_style_3vhmZK passport_number', 'disabled'=>'true','style'=>'background-color:#ddd!important']) !!}
    </div>
  </div>
</div>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
      <div class="autocomplete-input-container">
        <div class="autocomplete-input">
           {!! Form::text('address_line1', @$result->driver_address->address_line1, ['class' => '_style_3vhmZK','placeholder' => trans('messages.profile.addr'),'id' => 'address_line1','autocomplete' => 'false']) !!}  
        </div>
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-6" style="padding:6px 0px;">{{trans('messages.profile.emergency_contact')}}</label>
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
     <div class="autocomplete-input-container">
        <div class="autocomplete-input">
           {!! Form::text('address_line2',@$result->driver_address->address_line2, ['class' => '_style_3vhmZK','maxlength' => '11','placeholder' => trans('messages.profile.emergency_contact'),'id' => 'address_line2','autocomplete' => 'false']) !!}  
        </div>
        <ul class="autocomplete-results home_address">
        </ul>
      </div>
...
{{-- <div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
      {!! Form::text('city', @$result->driver_address->city, ['class' => '_style_3vhmZK','placeholder' => trans('messages.profile.profile_city'),'id' => 'city','style'=>'background-color:#ddd!important','disabled' => 'disabled']) !!}
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 25px 0px 15px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <select class="payment-select col-lg-4 col-md-4 col-sm-4 col-xs-12" name="country_code" tabindex="-1" title="" disabled="" style="background-color: #ddd">
