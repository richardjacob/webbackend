    ...
    <div style="padding:0px 15px;">
        ...
        <div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="    padding: 20px;">
            ...
            <div class="pull-right driver-status">
                ...
                <select style="font-size: 12px;padding: 9px 6px;margin: 0px 10px; width: 75% !important;" ng-model="earning_period" ng-init="earning_period='all_trips'" id='earning_period' ng-change="getPayment()">
