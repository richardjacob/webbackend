...
<p class="cmln__paragraph"><b>{{trans('messages.drive.all_round_initiatives_for_your_Trip_Safety')}}</b><br>{{trans('messages.drive.all_round_initiatives_for_your_Trip_Safety2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.protection_against_covid_19')}}</b><br>{{trans('messages.drive.protection_against_covid_192')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.a_great_Prices_without_Shock!')}}</b><br>{{trans('messages.drive.a_great_Prices_without_Shock!2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.driver_Screening')}}</b><br>{{trans('messages.drive.driver_Screening2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.sos_Button')}}</b><br>{{trans('messages.drive.sos_Button2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.immediate_pickups')}}</b><br>{{trans('messages.drive.immediate_pickups2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.high_quality_standards')}}</b><br>{{trans('messages.drive.high_quality_standards2')}}</p>
<p class="cmln__paragraph"><b>{{trans('messages.drive.with_you_on_the_road')}}</b><br>{{trans('messages.drive.with_you_on_the_road2')}}</p>

{{-- <p class="cmln__paragraph"><b>{{trans('messages.drive.sub_number')}}</b><br>{{trans('messages.drive.location_around_world')}} {{$site_name}} {{trans('messages.drive.stays_private')}} </p> --}}
