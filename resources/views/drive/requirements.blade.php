...
{{-- <li class="cmln__paragraph"><a href="#">{{trans('messages.drive.driver_license')}}</a></li>
<li class="cmln__paragraph"><a href="#">{{trans('messages.drive.tlc_license')}} </a></li> --}}
{{-- <li class="cmln__paragraph"><a href="#">{{trans('messages.drive.tlc_license_vehicle')}}</a></li> --}}
<li class="cmln__paragraph">{{trans('messages.drive.updated_driving_license')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.nid_passport')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.enlistment_certificate')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.vehicle_insurance')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.tax_token')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.updated_fitness_paper')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.vehicle_registration_paper')}}</li>
</div>
</div>
...
<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 pad-md">
<p class="_style_ZJW1y" style="margin: 10px 0px 20px !important; min-height: unset;">{{trans('messages.drive.follow_the_registration_steps')}}</p>
{{-- <p class="cmln__paragraph">{{trans('messages.drive.addition_documents')}}</p>
<li class="cmln__paragraph"><a href="#">{{trans('messages.drive.proof_insurance')}}</a></li>
<li class="cmln__paragraph"><a href="#">{{trans('messages.drive.proof_vehicle_registration')}}</a></li>
<li class="cmln__paragraph"><a href="#">{{trans('messages.drive.vehicle_permit')}}</a></li> --}}
<li class="cmln__paragraph">{{trans('messages.drive.fill_up_the_signup_form')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.upload_the_scan_copy_of_required_documents')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.wait_for_the_confirmation')}}</li>
<li class="cmln__paragraph">{{trans('messages.drive.start_earning')}}</li>
</div>
</div>
</div>
