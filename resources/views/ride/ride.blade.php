...
<!--Old-->
<!--<div class="pattern" style="height: 520px; width: 274px; right: 0px; position: absolute; z-index: 10;">-->
<!--    <div style="background-color: #A6DAEC; height: 100%; overflow: hidden;"><div aria-label="Decorative pattern" style="height: 100%;"><div class="isvg loaded" style="height: 100%;"><img src="{{url('images/icon/patten_274_520.jpg')}}">-->
<!--</div>-->
<!--</div>-->
<!--</div>-->
<!--</div>-->
...
<!--      <div class="isvg loaded" style="height: 100%;">-->
