  <div class="alert cookie-alert alert-dismissible" style="display:none">
    ...
    <p>
      {{trans('messages.footer.using_cookies',['site_name'=> Config('app.name')])}} <a href="{{url('privacy_policy')}}">{{trans('messages.user.privacy')}}.</a>
    </p>
  </div>
...
@if (
  Route::current()->uri() == 'signup_rider' || 
  Route::current()->uri() == 'signup_driver' || 
  Route::current()->uri() == 'signup_company' || 
  Route::current()->uri() == 'driver_profile'|| 
  Route::current()->uri() == 'forgot_password_driver'|| 
  Route::current()->uri() == 'forgotpassword'|| 
  Route::current()->uri() == 'profile' ||
  Route::current()->uri() == 'forgot_password_rider' ||
  Route::current()->uri() == 'forgot_password_company'
  ) 
