		...
		<div class="footer-head">
			...
			<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
				...
				<div style="padding:20px 0px;;">
					<a href="{{ url('ride') }}" class="city-link col-sm-4" style="color:#fff;font-size:15px !important;">{{trans('messages.footer.ride')}}
					</a>
				
					<a href="{{ url('drive') }}" class="city-link col-sm-4" style="color:#fff">{{trans('messages.footer.drive')}}
					</a>
				
					<a href="{{ url('safety') }}" class="city-link col-sm-4" style="color:#fff">{{trans('messages.footer.safety')}}
					</a>
				</div>
			</div>
			<div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
			...
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" >
				<div class="text-center footlo">
					<span class="_style_zVjAb" dir="ltr" data-reactid="661">© {{ Config('app.name') }} LTD.</span> <!-- $ site_name -->
				</div>
			</div>
		</div>
	</div>
