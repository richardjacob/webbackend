	...
	<div style="padding:0px 15px;">
		...
		<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 25px 0px 15px;">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  countrylist" style="padding:0px;">
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7  countrylist" style="padding:0px;">
