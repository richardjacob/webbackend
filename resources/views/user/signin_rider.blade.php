         ...
         <div data-reactid="12">
            <form class="push--top-small forward" method="POST" data-reactid="13">
                  ...
                  <div style="width:100%;" data-reactid="17">
                     ...
                     <div style="font-family:ff-clan-web-pro, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;font-weight:500;font-size:14px;line-height:24px;text-align:none;color:#3e3e3e;box-sizing:border-box;margin-bottom:24px;" data-reactid="19">
                        <div class="_style_CZTQ8" data-reactid="20">
                           <input class="text-input input-group-addon" id="email_phone" maxlength="11" placeholder="{{trans('messages.user.email_mobile')}}" autocorrect="off" autocapitalize="off" name="textInputValue" data-reactid="21" type="text" value="{{ canDisplayCredentials() ? '98765432106':'' }}" ng-init="invalid_email= '{{trans('messages.user.email_mobile')}}';" >
                        </div>
               ...
               <div data-reactid="15" class="password-sec hide">
                  ...
                  <div style="width:100%;" data-reactid="17">
                     <div style="font-family:ff-clan-web-pro, &quot;Helvetica Neue&quot;, Helvetica, sans-serif;font-weight:500;font-size:14px;line-height:24px;text-align:none;color:#3e3e3e;box-sizing:border-box;margin-bottom:24px;" data-reactid="19">
                        <div class="_style_CZTQ8" data-reactid="20" style="float:left;width:90%">
                        ...
                        <div style="float:right;width:30px;padding-top:10px;margin-bottom:20px">
                          <img src="{{url('images/vissible.png')}}" id="vissible_invissible" onclick="showpass()" style="width:30px; height:20px;">
                        </div>
...
function showpass() {
  ...
  if (x.type === "password") {
    x.type = "text";
    $("#vissible_invissible").attr("src", "{{url('images/invissible.png')}}");

  } else {
    x.type = "password";
    $("#vissible_invissible").attr("src", "{{url('images/vissible.png')}}");
