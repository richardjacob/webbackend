            ...
            <tbody>
                @forelse($rows as $date => $row)
                    <tr>
                        ...
                        <td class="text-right">
                            <!--    
                                {{ route('log-viewer::logs.filter', [$date, $key]) }}
                                {{ route('log-viewer::logs.show', [$date]) }}
                                {{ route('log-viewer::logs.download', [$date]) }}
                            -->
                            <a href="{{url($domain.'logs/'.$date)}}" class="btn btn-sm btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{url($domain.'logs/'.$date.'/download')}}" class="btn btn-sm btn-success">
