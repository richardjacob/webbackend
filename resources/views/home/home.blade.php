...
<div class="" ng-controller="user">
	<div class="container" >
		<div class="pad-44">
			...
			<p class="slide-content">{{trans('messages.home.desc')}}</p></div>
								...
								<div class="layout__item one-whole margin-medium margin-side">
									...
									@if(Auth::guard('company')->user()==null && Auth::user()==null)
									 <div class="background-line">
										<span class="push-tiny--sides text--uppercase small">{{trans('messages.home.or')}}</span>
									</div> 
										 <div class="layout__item one-whole margin-medium margin-side">
											<div class="home__preview-driver-image company-signup-icon float--left">
											...
											<div class="float--left ride-header">	
												<h4 class="flush hard">{{trans('messages.home.siginup_company')}}</h4>
												<a class="btn btn--link hard--bottom rider-signup text--uppercase primary-font--bold borderless--left" href="{{ url('signup_company') }}">
													<!-- react-text: 6995 -->
													{{trans('messages.home.siginup')}}
													<!-- /react-text -->
													<i class="icon icon_right-arrow push-tiny--left">
													</i>
												</a>
											</div>
											@endif
