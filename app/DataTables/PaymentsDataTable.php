...
class PaymentsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('2nd_rider_amount', function ($trips) {   
                return html_entity_decode(@$trips->currency->symbol).$trips->additional_rider_amount;
            })
            ->addColumn('total_fare', function ($trips) {   
                return html_entity_decode(@$trips->currency->symbol).number_format($trips->admin_total_amount + $trips->additional_rider_amount,2,'.','');
            })
    ...
    {
        $trips = $model->where(function($query)  {
    ...
    protected function getColumns()
    {
        ...
        $col_list_2 = [
            ...
            ['data' => '2nd_rider_amount', 'title' => '2nd Rider Amount(Pool)'],
