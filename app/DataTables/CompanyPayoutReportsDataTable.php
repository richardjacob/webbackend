    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('company_payout', function ($trips) {                
                return html_entity_decode(@$trips->currency->symbol).self::getCompanyPayout($trips);
            })
                ...
                if($this->filter_type == 'day_report') {
                    ...
                    //     </form>';
                        ...
                        <label class="btn btn-xs btn-primary" onclick="make_payout_modal_company(\''.@$account_number.'\', 
                            ...
                            \''.$trips->company_id.'\', 
                            \''.$payout_method_data.'\',
                            \'admin/per_day_report/company/'.$trips->company_id.'/'.request()->date.'\', 
                            \''.$payout_text.'\', 
                            \'\', 
                            \'\', 
                            \'\',
                    ...
                    //     </form>';
                        ...
                        <label class="btn btn-xs btn-primary" onclick="make_payout_modal_company(\''.@$account_number.'\', 
                            ...
                            \''.$trips->company_id.'\', 
                            \''.$payout_method_data.'\',
                            \'admin/per_week_report/company/'.$trips->company_id.'/'.request()->start_date.'/'.request()->end_date.'\', 
                            \''.$payout_text.'\', 
                            \'\', 
                            \'\', 
