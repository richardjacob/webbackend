...
class EmailController extends Controller
{
    ...
    public function forgot_password_link($user,$user_type)
    {
        ...
        $password_resets->user_type  = $user_type;
    ...
    public function otp_forgot_password_link($user,$user_type)
    {
        $token = str_random(100); 
        // if (env('ROOT_DOMAIN_SUB_DOMAIN') != '') {
        //     $url = env('ROOT_DOMAIN_SUB_DOMAIN') . '.' . env('DOMAIN').'/';
        //     $url = '';
        // } else {
        //     $url = env('DOMAIN').'/';
        // }
        ...
        $password_resets = new PasswordResets;
        $password_resets->email      = $user->mobile_number;
        ...
        $url = '/reset_password?secret='.$token;
     ...
     * @return true
     */
    public function company_forgot_password_link($company,$user_type)
    {
