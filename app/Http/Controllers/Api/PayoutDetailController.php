...
class PayoutDetailController extends Controller
{
    ...
    {
        Log::info("earning_list Api Stp:1 :", $request->all());
        ...
        CustomLog::info("earning_list Api Stp:2 :");
    ...
    {
        Log::info("weekly_trip Api Stp:1 :");
        ...
        CustomLog::info("weekly_trip Api Stp:2 :");
    ...
    {
        Log::info("weekly_statement Api Stp:1 :", $request->all());
        ...
        CustomLog::info("weekly_statement Api Stp:2 :");
    ...
    {
        Log::info("daily_statement Api Stp:1 :", $request->all());
        ...
        CustomLog::info("daily_statement Api Stp:2 :");
        return response()->json([
            'status_code' => '1',
    ...
    {
        Log::info("update_payout_preference Api Stp:1 :", $request->all());
        ...
        //$payout_service = resolve('App\Services\Payouts\\'.ucwords($request->payout_method).'Payout');
        ...
        //     $payout_method = strtolower($payout_method);
        // }

        // if ($payout_method == 'nagad' || $payout_method == 'bkash' || $payout_method == 'rocket' || $payout_method == 'upay') {
        ...
        $payout_credentials->payout_id = $request->payout_email ?? $request->account_number;
        ...
        CustomLog::info("update_payout_preference Api Stp:2 :");
    ...
    {
        Log::info("get_payout_list Api Stp:1 :", $request->all());
        ...
        if ($request->filled('type')) {
            ...
            if ($request->type == 'default') {
                PayoutCredentials::where('user_id', $user->id)
                                    ->where('id','!=', $payout_id) //added by Taslim
                                    ->update(['default' => 'no']);
        ...
        foreach ($payout_methods as $method) {
            ...
            $payout_credential = $payout_credentials->where('type', $method)->first();
            ...
            if ($method == 'banktransfer') {
                $data = array(
                    ...
                    'holder_type'           => $preference->holder_type ?? '',
        ...
        CustomLog::info("get_payout_list Api Stp:2 :");
    ...
    {
        Log::info("stripe_supported_country_list Api Stp:1 :", $request->all());
        ...
        CustomLog::info("stripe_supported_country_list Api Stp:2 :");
        return response()->json([
            'status_code'       => '1',
