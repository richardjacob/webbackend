...
use App\DataTables\OweCompanyDataTable;
...
class OweController extends Controller
{
    ...
    public function dues( OweCompanyDataTable $owe_amount)
    {//DriverPaymentDataTable $driver_payment,
        $this->view_data['main_title'] = 'Dues';
        return $owe_amount->setFilterType('overall')->render('admin.owe.index',$this->view_data);
    }
