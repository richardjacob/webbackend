...
class WalletController extends Controller
{
    ...
    {
        $this->view_data['main_title']  = 'Manage Balance';
        ...
        $this->view_data['sub_title'] = $this->user_type.' Balance';
    ...
    public function add(Request $request)
    {
        ...
        ->whereNull('wallet.user_id')->where('users.user_type',$this->user_type)->whereStatus('Active')->pluck('users.first_name','users.id');
        ...
        if(!$_POST) {
            ...
            $wallet = new Wallet;
            $wallet->user_type      = User::where('id', $request->user_id)->pluck('user_type')->first();
