...
class EntrustPermission
{
    ...
    public function __construct()
    {
        ...
        $this->hub_auth = auth('hub');

        // Roles can visible to company
        $this->company_role = array('driver_offer', 'manage_manual_booking', 'manage_trips', 'view_driver', 'create_driver', 'update_driver', 'delete_driver', 'update_company', 'manage_statements', 'manage_cancel_trips', 'manage_owe_amount', 'manage_send_message', 'manage_driver_payments', 'manage_map', 'manage_heat_map', 'manage_payments', 'manage_rating', 'manage_requests', 'manage_vehicle');

        $this->hub_role = array('employee');
    }
