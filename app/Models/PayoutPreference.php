...
class PayoutPreference extends Model implements Auditable
{
	...
	protected static $logAttributes = [
		'user_id', ' address1', 'address2', 'city', 'state', 'postal_code', 'country', 'payout_method', 'paypal_email', 'currency_code', 'routing_number',
