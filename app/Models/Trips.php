...
class Trips extends Model implements Auditable
{
    ...
    protected static $logAttributes = [
        'user_id', 'pool_id', 'pickup_latitude', 'pickup_longitude', 'drop_latitude', 'drop_longitude', 'pickup_location', 'drop_location', 'car_id', 'request_id',
        'driver_id', 'trip_path', 'map_image', 'total_time', 'total_km', 'time_fare', 'distance_fare', 'base_fare', 'additional_rider', 'additional_rider_amount', 'peak_fare',
        'peak_amount', 'driver_peak_amount', 'schedule_fare', 'access_fee', 'tips', 'waiting_charge', 'toll_reason_id', 'toll_fee', 'wallet_amount', 'promo_amount', 'subtotal_fare',
        'total_fare', 'driver_payout', 'driver_or_company_commission', 'owe_amount', 'remaining_owe_amount', 'applied_owe_amount', 'to_trip_id', 'arrive_time', 'begin_trip',
        'end_trip', 'paykey', 'payment_mode', 'payment_status', 'is_calculation', 'currency_code', 'fare_estimation', 'status', 'otp'
    ];
    ...
    {
        $profile_picture = Cache()->remember('profile_picture'.$this->attributes['driver_id'], Config('cache.one_month'), function(){
                 return ProfilePicture::find($this->attributes['driver_id']);
             });
    ...
    {
        $profile_picture = Cache()->remember('profile_picture'.$this->attributes['user_id'], Config('cache.one_month'), function(){
                 return ProfilePicture::find($this->attributes['user_id']);
             });
