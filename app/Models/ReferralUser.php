...
class ReferralUser extends Model  implements Auditable
{
    ...
    protected $appends = ['referred_user_name', 'remaining_days', 'remaining_trips', 'earnable_amount', 'trans_payment_status'];

    public $disable_admin_panel_convertion = true;

    protected static $logAttributes = [
        'user_id', 'referral_id', 'user_type', 'days', 'trips', 'start_date', 'end_date', 'currency_code', 'amount', 'pending_amount', 'payment_status'
    ];
